...
# === API 蓝图 ===
from core.api.v1 import cards, world_info, system, resources, automation, extensions, presets, st_sync, chats, beautify, forum
...
def create_app():
    ...
    app.register_blueprint(forum.bp)       # 类脑搜索站预览转发
