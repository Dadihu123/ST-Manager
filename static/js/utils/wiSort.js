...
export const WI_SORT_OPTIONS = [
  ...
  { value: "tokens_asc", label: "Token 升序", shortLabel: "Token 升序" },
  { value: "tokens_desc", label: "Token 降序", shortLabel: "Token 降序" },
  { value: "depth_asc", label: "深度 升序", shortLabel: "深度 升序" },
  { value: "depth_desc", label: "深度 降序", shortLabel: "深度 降序" },
  { value: "order_asc", label: "Order 升序", shortLabel: "Order 升序" },
  { value: "order_desc", label: "Order 降序", shortLabel: "Order 降序" },
  { value: "uid_asc", label: "UID 升序", shortLabel: "UID 升序" },
  { value: "uid_desc", label: "UID 降序", shortLabel: "UID 降序" },
  { value: "probability_asc", label: "触发率 升序", shortLabel: "触发率 升序" },
  { value: "probability_desc", label: "触发率 降序", shortLabel: "触发率 降序" },
];
